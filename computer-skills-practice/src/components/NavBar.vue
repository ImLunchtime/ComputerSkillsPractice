<template>
  <nav class="bg-white shadow-md border-b w-full mb-6">
    <div class="mx-auto px-4">
      <div class="flex justify-between items-center h-16">
        ...
        <div v-if="user" class="flex items-center space-x-4">
          ...
          <!-- 用户菜单 -->
          <div class="relative">
            <button @click="showUserMenu = !showUserMenu" class="text-gray-600 hover:text-gray-900 focus:outline-none">
            ...
            <div v-if="showUserMenu" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50">
              ...
              <router-link v-if="user.role === 'admin'" to="/admin" @click="showUserMenu = false"
                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                管理员中心
              </router-link>
            </div>
           ...
           <!-- 退出登录按钮 -->
          <BaseButton variant="red-outline" @click="logout">
            退出登录
          </BaseButton>
        </div>
